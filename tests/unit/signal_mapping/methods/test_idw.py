...
class TestIDWInterpolation:
    ...
    def test_idw_interpolation_creation_custom(self):
        ...
        method = IDWInterpolation(power=3.0, k_neighbors=6, radius=2.0)
    ...
    def test_interpolate_power_parameter_effect(self):
        ...
        assert len(result_low.voxels) > 0
        assert len(result_high.voxels) > 0
    ...
    def test_interpolate_with_radius(self):
        ...
        method = IDWInterpolation(power=2.0, k_neighbors=8, radius=1.0)
