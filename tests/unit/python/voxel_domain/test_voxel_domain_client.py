...
VoxelDomainClient uses: voxelization (uniform_resolution.VoxelGrid, adaptive_resolution.AdaptiveResolutionGrid),
query.unified_query_client, coordinate_systems.CoordinateSystemTransformer, signal_mapping.execution.sequential.
"""
...
try:
    ...
    from am_qadf.voxelization import VoxelGrid, AdaptiveResolutionGrid
    VOXELIZATION_AVAILABLE = True
except ImportError:
    VoxelDomainClient = None
    VoxelGrid = None
...
@pytest.mark.skipif(
    not VOXELIZATION_AVAILABLE or VoxelDomainClient is None,
    reason="VoxelDomainClient or voxelization/coordinate_systems not available",
)
