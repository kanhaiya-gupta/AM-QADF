...
class TestVoxelFusionBenchmarks:
    ...
    def test_fusion_small_grids(self, benchmark):
        ...
        try:
            ...
            def run_fusion():
                return fusion.fuse_grids(grids, strategy="weighted_average")
    ...
    def test_fusion_different_methods(self, benchmark):
        ...
        try:
            ...
            for strategy in strategies:
                ...
                def run_fusion():
                    return fusion.fuse_grids(grids, strategy=strategy)
    ...
    @pytest.mark.benchmark
    def test_fusion_weighted_average(self, benchmark):
        """Benchmark weighted-average fusion with explicit weights."""
        try:
            from am_qadf.fusion.voxel_fusion import VoxelFusion
            ...
            def run_fusion():
                return fusion.fuse_grids(grids, strategy="weighted_average", weights=weights)
