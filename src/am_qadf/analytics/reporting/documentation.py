...
class AnalysisDocumentation:
    ...
    def generate_user_guide(self, doc_title: str = "PBF-LB/M Analytics User Guide") -> DocumentationResult:
        """
    ...
    def generate_api_documentation(self, doc_title: str = "PBF-LB/M Analytics API Documentation") -> DocumentationResult:
        """
    ...
    def _generate_user_guide_markdown(self, doc_title: str) -> str:
        ...
        # Use regular string concatenation to avoid f-string issues with code blocks containing braces
...
```python
from am_qadf.analytics import GlobalSensitivityAnalyzer
...
print("Analysis time:", round(result.analysis_time, 2), "s")
```
...
```python
from am_qadf.analytics import SobolAnalyzer
...
```python
from am_qadf.analytics import MorrisAnalyzer
...
```python
from am_qadf.analytics import MultivariateAnalyzer

analyzer = MultivariateAnalyzer()
result = analyzer.analyze_pca(data, feature_names)

# Access PCA results
print("Explained variance:", round(result.explained_variance['total_variance_explained'], 4))
```

### Time Series Analysis

```python
from am_qadf.analytics import TimeSeriesAnalyzer

analyzer = TimeSeriesAnalyzer()
result = analyzer.analyze_trend(time_series_data)

# Access trend results
print("Trend direction:", result.trend_analysis['trend_direction'])
```
...
```python
from am_qadf.analytics import ParameterAnalyzer
...
```python
from am_qadf.analytics import QualityAnalyzer

analyzer = QualityAnalyzer()
result = analyzer.analyze_quality_prediction(process_data, quality_target)

# Access quality metrics
print("Mean quality:", round(result.quality_metrics['mean_quality'], 4))
```
...
```python
from am_qadf.analytics import AnalysisReportGenerator
...
```python
from am_qadf.analytics import AnalysisVisualizer

visualizer = AnalysisVisualizer()
result = visualizer.visualize_sensitivity_analysis(sensitivity_results)

print("Plots generated:", result.plot_paths)
```
...
```python
from am_qadf.analytics.examples import AnalyticsExample
...
pip install pymc3  # For Bayesian analysis (optional)</code></pre>
    ...
    <h3>Basic Usage</h3>
    <pre><code>from am_qadf.analytics import GlobalSensitivityAnalyzer
...
# Print results
print("Analysis successful:", result.success)
print("Analysis time:", round(result.analysis_time, 2), "s")</code></pre>
...
if result.success:
    ...
    print("Analysis failed:", result.error_message)
```
