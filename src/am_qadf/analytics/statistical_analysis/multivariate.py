...
class MultivariateAnalyzer:
    ...
    def analyze_correlation(self, data: pd.DataFrame, feature_names: List[str] = None) -> MultivariateResult:
        """
    ...
    def _perform_hierarchical_clustering(self, X: np.ndarray, n_clusters: int) -> Dict[str, Any]:
        ...
        return {"labels": labels, "centers": None, "linkage_matrix": linkage_matrix}
