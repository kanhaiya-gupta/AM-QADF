...
class LocalSensitivityAnalyzer:
    ...
    def analyze_derivatives(
        ...
        try:
            ...
            derivatives, has_errors = self._calculate_derivatives(model_function, nominal_array, parameter_names)
            ...
            # Create result - set success=False if errors occurred
            result = LocalSensitivityResult(
                ...
                error_message=("Model errors occurred during derivative calculation" if has_errors else None),
            )
    ...
    def analyze_automatic_differentiation(
        ...
        try:
            ...
            derivatives = approx_fprime(nominal_array, model_function, epsilon=self.config.step_size)
    ...
    def _calculate_derivatives(
        ...
        Returns:
            Tuple of (derivatives dict, has_errors bool)
        """
        derivatives = {}
        has_errors = False
